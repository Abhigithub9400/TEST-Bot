                        ...
                        <table cellpadding="0" cellspacing="0" border="0" role="presentation" style="margin: 0; border-spacing: 0">
                          <tr>
                            ...
                            <td valign="top" width="364.07" style="padding-top: 38.87px; padding-left: 8px; width: 364.07px; vertical-align: top">
                              <a href="{{DOMAIN URL}}" target="_blank" style="text-decoration: none;"><img src="{{MEDIASSIST LOGO}}" alt="mediassist" width="197" style="max-width: initial; width: 136px; display: block" /></a>
                            </td>
                            <!--[if mso]></tr></table></td><![endif]-->
              ...
              <tr>
                <td style="padding-top: 12px; padding-left: 32px; padding-right: 32px">
                  <table class="bg-fffffe" cellpadding="0" cellspacing="0" border="0" role="presentation" bgcolor="white" width="536.00" style="border-radius: 8px; background-color: white; width: 536px; border-spacing: 0; margin-top: -0.5px; border-collapse: separate">
                    <tr>
                      <td align="left" valign="top" width="100.00%" style="padding-top: 31px; padding-bottom: 41px; padding-left: 30px; width: 100%; vertical-align: top">
                    ...
                    <tr>
                      <td align="left" valign="top" width="100.00%" style="padding-top: 31px; padding-bottom: 41px; padding-left: 30px; width: 100%; vertical-align: top">
                        <table cellpadding="0" cellspacing="0" border="0" role="presentation" width="100.00%" style="margin: 0; width: 100%; border-spacing: 0">
                          <tr>
                            <td style="padding-bottom: 8px">
                              <p class="color-000001" width="100.00%" style="font-size: 16px; font-weight: 400; color: black; margin: 0; padding: 0; width: 100%; line-height: 19px; mso-line-height-alt: 20px">Dear BDE Team,</p>
                            </td>
                          </tr>
                          <tr>
                            <td style="padding-top: 8px; padding-bottom: 8px">
...
BEGIN
    ...
    (
        'MEDI_3_1_E1', 
        'Plan Inquiry from Registered User', 
...
BEGIN
    ...
    (
        ...
        'Dear {{USER NAME}},\n\nGreetings from {{DOMAIN NAME}} AI.\n\nThank you for your interest in our paid plans. Our team will reach out to you shortly to discuss your requirements.\n\nBest regards,\n{{DOMAIN NAME}} Team', 
        '<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html lang="en" dir="ltr" xmlns="http://www.w3.org/1999/xhtml">
  <head>
    <style type="text/css">
                    ...
                    <tr>
                      <td align="left" valign="top" width="100.00%" style="padding-top: 31px; padding-bottom: 41px; padding-left: 30px; width: 100%; vertical-align: top">
                        <table cellpadding="0" cellspacing="0" border="0" role="presentation" width="100.00%" style="margin: 0; width: 100%; border-spacing: 0">
                          ...
                          <tr>
                            <td style="padding-top: 8px; padding-bottom: 8px">
                              <p class="color-000001" width="100.00%" style="font-size: 16px; font-weight: 400; color: black; margin: 0; padding: 0; width: 100%; line-height: 24px; mso-line-height-alt: 24px">Thank you for your interest in our paid plans. Our team will reach out to you shortly to discuss your requirements..</p>
                            </td>
                          </tr>
                          <tr>
                            <td style="padding-top: 8px">
